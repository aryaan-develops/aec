            ...
            <div className={styles.mainContent}>
                            ...
                            <tbody>
                                {leads.map(lead => (
                                    <tr key={lead._id}>
                                        ...
                                        <td><button className={`${styles.actionsBtn} ${styles.deleteBtn}`} onClick={() => deleteItem('leads', lead._id)}>Delete</button></td>
                                    </tr>
                                ))}
                            </tbody>
                        </table>
                ...
                {activeTab === 'notices' && (
                    <div className={styles.card}>
                        ...
                        <table className={styles.table}>
                            <thead><tr><th>Type</th><th>Notice</th><th>Actions</th></tr></thead>
                            <tbody>
                                {notices.map(n => (
                                    <tr key={n._id}>
                                        <td><span className={`${styles.status} ${styles.statusNew}`}>{n.type}</span></td>
                                        <td><strong>{n.title}</strong><br/>{n.content}</td>
            ...
            {isNoticeModalOpen && (
                <div className={styles.formModal}>
                    <div className={styles.modalContent}>
                        ...
                        <button className={styles.addBtn} onClick={() => addItem('notices', newNotice, () => setIsNoticeModalOpen(false), () => setNewNotice({title:'', content:'', type:'info'}))}>Save</button>
